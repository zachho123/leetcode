...
function search(nums, target) {
    ...
    while (start <= end) {
        ...
        // If we can't tell which side is sorted due to duplicates,
        // move our edges in
...
(function runTests() {
    let tests = [
        { input: { nums: [], target: 0 }, output: false },
        { input: { nums: [1], target: 1 }, output: true },
        { input: { nums: [1, 2], target: 2 }, output: true },
        { input: { nums: [2, 1], target: 1 }, output: true },
        { input: { nums: [2,5,6,0,0,1,2], target: 0 }, output: true },
        { input: { nums: [2,5,6,0,0,1,2], target: 3 }, output: false },
        { input: { nums: [1,3,1,1,1], target: 3 }, output: true }
    ];
